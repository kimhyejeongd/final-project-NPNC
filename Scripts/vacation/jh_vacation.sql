...
ALTER TABLE VACATION_APPLY 
    MODIFY VACATION_APPLY_DATE TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL;

ALTER TABLE VACATION_APPLY MODIFY VACATION_START_DATE timestamp NOT null;
