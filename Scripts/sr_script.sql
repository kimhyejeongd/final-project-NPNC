...
UPDATE POST_MESSAGE_RECEIVER SET BOOKMARK_STATUS ='Y' WHERE POST_MSG_REC_KEY ='4' AND MEMBER_REC_KEY=2;
...
ADD (READ_STATUS VARCHAR2(10)  DEFAULT 'N' NOT NULL);

ALTER TABLE POST_MESSAGE_RECEIVER
ADD (BOOKMARK_STATUS VARCHAR2(10)  DEFAULT 'N' NOT NULL);
