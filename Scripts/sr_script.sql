...
SELECT * FROM POST_MESSAGE pm ;
 alter table POST_MESSAGE modify(POST_MSG_DETAIL VARCHAR2(1000));
-- NOTE pk
...
INSERT INTO POST_MESSAGE VALUES(SEQ_PM.NEXTVAL ,1 ,'SKLFDJGKLSDFJGKLSDFJGKLSJDFGL;KJSDFLK;GJKL;DSFJGK;LSDJFGK;LSJDFK;LGJSK;LDFJGK;LSJDFK;LGJS;KLDFJGKL;SDJFG;KL' ,SYSDATE ,null);
