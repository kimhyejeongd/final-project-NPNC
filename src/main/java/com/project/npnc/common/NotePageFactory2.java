...
public String getPage(int cPage,int numPerpage,int totalData,String url) {
		...
		if(pageNo==1) {
			...
			sb.append("<a class='page-link' href='javascript:fn_paging2("+(pageNo-1)+")'>이전</a>");
			sb.append("</li>");
		}
		...
		while(!(pageNo>pageEnd||pageNo>totalPage)) {
			if(pageNo==cPage) {
				...
				sb.append("<li class='page-item'>");
				sb.append("<a class='page-link' href='javascript:fn_paging2("+pageNo+")'>"+pageNo+"</a>");
				sb.append("</li>");
			}
			pageNo++;
		}
		if(pageNo>totalPage) {
			...
			sb.append("<li class='page-item'>");
			sb.append("<a class='page-link' href='javascript:fn_paging2("+(pageNo)+")'>다음</a>");
			sb.append("</li>");
		}
//		sb.append("<ul>");
//		sb.append("<script>");
//		sb.append("function fn_paging2(pageNo){");
