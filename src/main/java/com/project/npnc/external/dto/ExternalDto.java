...
public class ExternalDto {
    ...
    // Setter에서 'undefined' 값을 처리하는 방법
    public void setAB_EXTERNAL_BOOKMARK(String AB_EXTERNAL_BOOKMARK) {
        this.AB_EXTERNAL_BOOKMARK = (AB_EXTERNAL_BOOKMARK != null && !AB_EXTERNAL_BOOKMARK.equals("undefined")) ? AB_EXTERNAL_BOOKMARK : "N";
    }
}
