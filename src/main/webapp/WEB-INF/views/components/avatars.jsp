...
<head>
	...
	<script>
		WebFont.load({
			...
			custom: {"families":["Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands", "simple-line-icons"], urls: ['${path}/resources/assets/css/fonts.min.css']},
			active: function() {
...
<body>
						...
						<ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
									...
									<li>
										<div class="message-notif-scroll scrollbar-outer">
											<div class="notif-center">
												<a href="#">
													<div class="notif-img"> 
														<img src="${path}/resources/assets/img/jm_denis.jpg" alt="Img Profile">
													</div>
												...
												<a href="#">
													<div class="notif-img"> 
														<img src="${path}/resources/assets/img/chadengle.jpg" alt="Img Profile">
													</div>
													<div class="notif-content">
												...
												<a href="#">
													<div class="notif-img"> 
														<img src="${path}/resources/assets/img/mlane.jpg" alt="Img Profile">
													</div>
													<div class="notif-content">
												...
												<a href="#">
													<div class="notif-img"> 
														<img src="${path}/resources/assets/img/talha.jpg" alt="Img Profile">
													</div>
													<div class="notif-content">
									...
									<li>
										<div class="notif-scroll scrollbar-outer">
											<div class="notif-center">
												...
												<a href="#">
													<div class="notif-img"> 
														<img src="${path}/resources/assets/img/profile2.jpg" alt="Img Profile">
													</div>
													<div class="notif-content">
														<span class="block">
							...
							<li class="nav-item topbar-user dropdown hidden-caret">
								<a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
									<div class="avatar-sm">
										<img src="${path}/resources/assets/img/profile.jpg" alt="..." class="avatar-img rounded-circle">
									</div>
								...
								<ul class="dropdown-menu dropdown-user animated fadeIn">
									<div class="dropdown-user-scroll scrollbar-outer">
										<li>
											<div class="user-box">
												<div class="avatar-lg"><img src="${path}/resources/assets/img/profile.jpg" alt="image profile" class="avatar-img rounded"></div>
												<div class="u-text">
													<h4>Hizrian</h4>
								...
								<div class="card-body">
									<p class="demo">
										<div class="avatar avatar-xxl">
											<img src="${path}/resources/assets/img/jm_denis.jpg" alt="..." class="avatar-img rounded-circle">
										</div>
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<p class="demo">
										<div class="avatar">
											<img src="${path}/resources/assets/img/jm_denis.jpg" alt="..." class="avatar-img rounded">
										</div>
								...
								<div class="card-body">
									<p class="demo">
										<div class="avatar-group">
											<div class="avatar">
												<img src="${path}/resources/assets/img/jm_denis.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="${path}/resources/assets/img/chadengle.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="${path}/resources/assets/img/mlane.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
	...
	<script src="${path}/resources/assets/js/setting-demo2.js"></script>
</body>
</html>