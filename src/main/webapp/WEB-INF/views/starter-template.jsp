                      ...
                      <div class="card-tools">
                        <ul class="nav nav-pills nav-secondary nav-pills-no-bd nav-sm" id="pills-tab" role="tablist">
                          <li class="nav-item submenu" role="presentation">
                            <a class="nav-link" id="pills-today" data-bs-toggle="pill" href="#pills-today" role="tab" aria-selected="true" tabindex="-1" aria-labelledby="pills-today">Today</a>
                          </li>
                          <li class="nav-item submenu" role="presentation">
                            <a class="nav-link" id="pills-week" data-bs-toggle="pill" href="#pills-week" role="tab" aria-selected="false" aria-labelledby="pills-week" tabindex="-1">Week</a>
                          </li>
                          <li class="nav-item submenu" role="presentation">
                            <a class="nav-link" id="pills-month" data-bs-toggle="pill" href="#pills-month" role="tab" aria-selected="false" tabindex="-1" aria-labelledby="pills-month">Month</a>
                          </li>
                        </ul>
                      </div>
                    </div>
