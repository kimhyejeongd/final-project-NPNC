...
<html lang="ko">
  ...
  <script src="${path}/resources/jh/js/pending.js"></script>
  <body>
    <div class="wrapper">
      <!-- Sidebar -->
				   ...
				   <div class="card card-round">
				     <div class="card-header">
				       <div class="card-head-row card-tools-still-right">
				         <div class="card-title">결재 보류 문서</div>
				     ...
				     <div class="card-body p-0">
				       <div class="table-responsive">
				         <!-- Projects table -->
				         <table class="table table-hover align-items-center mb-0" id="pendingTable">
				           ...
				           <tbody>
				             <c:if test="${empty pendinglist}">
				              <tr class="text-center">
				              	<td colspan="6">결재를 보류한 문서가 없습니다</td>
				             	</tr>
				             </c:if>
				             <c:if test="${pendinglist ne null}">
				             	<c:forEach items="${pendinglist }" var="l" varStatus="vs">
